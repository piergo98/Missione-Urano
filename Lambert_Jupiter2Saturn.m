...
[coe1, r1, v1, jd1] = planet_elements_and_sv(5, 2026, 06, 09, 12, 00, 00);
% Position of Saturn at the arrival  (km)     
[coe2, r2, v2, jd2] = planet_elements_and_sv(6, 2028, 07, 27, 12, 00, 00);
% TOF (s)
dt     = 67305600;                   
string = 'pro';
%...
...
fprintf('\n   v1 (km/s)                     = [%g  %g  %g]', ...
                                            v1_l(1), v1_l(2), v1_l(3))
fprintf('\n   v2 (km/s)                     = [%g  %g  %g]', ...
                                            v2_l(1), v2_l(2), v2_l(3))
