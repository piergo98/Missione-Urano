...
flyby_jupiter1(v_inf_down_saturn, f1_Saturn, p_Saturn, t_flyby_tot_Saturn, m_Saturn, r_Saturn)
function [y]= flyby_jupiter1(v_inf_down_Saturn, f1_Saturn, p_Saturn, t_flyby_tot_Saturn, m_Saturn, r_Saturn)
...
mu = G*(m1 + m2);
r1 = [p_Saturn*sin(f1_Saturn), p_Saturn*cos(f1_Saturn), 0];
