...
% Tempo di volo Terra-ingresso SOI di Giove
t_Earth = datetime(2022,07,01,12,00,00);
t_Jupiter = datetime(2024,07,01,12,00,00)-t_flyby_tot_day_Jupiter;
...
[~, r2_s, v2_s, ~] = planet_elements_and_sv(6, 2030, 8, 1, 12, 00, 00);

% Definisco il tempo di volo Giove Saturno
t_Jupiter = datetime(2024,07,01,12,00,00)+2*(t_flyby_tot_day_Jupiter);
t_Saturn = datetime(2030, 8, 1, 12, 00, 00)-t_flyby_tot_day_Saturn;
...
t_Saturn = datetime(2030, 08, 1, 12, 00, 00)+(2*t_flyby_tot_day_Saturn);
