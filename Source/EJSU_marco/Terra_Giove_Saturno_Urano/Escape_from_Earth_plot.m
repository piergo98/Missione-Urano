...
Escape_Earth1(v_infp_escape_Earth, f1_escape_Earth, p_escape_Earth, t_tot_escape_Earth, m_Earth, r_Earth)
function [y] = Escape_Earth1(v_infp_escape_Earth, f1_escape_Earth, p_escape_Earth, t_tot_escape_Earth, m_Earth, r_Earth)

hours = 3600;

%...Input data:
m1 = m_Earth   % Massa Terra in kg
R  = r_Earth;  % Raggio Terra
m2 = 10000;   %massa Spacecraft
G = 6.6742e-20; % Costante gravitazionale

t0 = 0;
tf = t_tot_escape_Earth;
%...End input data


%...Numerical integration:
mu = G*(m1 + m2);
r1 = [p_escape_Earth*sin(f1_escape_Earth), p_escape_Earth*cos(f1_escape_Earth), 0];
y0 = [r1 v_infp_escape_Earth]';
...
fprintf('\n The initial velocity is [%g, %g, %g] (km/s).',...
                                                     v_infp_escape_Earth(1), v_infp_escape_Earth(2), v_infp_escape_Earth(3))
fprintf('\n   Magnitude = %g km/s\n', norm(v_infp_escape_Earth))
fprintf('\n Initial time = %g h.\n Final time   = %g h.\n',0,tf/hours) 
