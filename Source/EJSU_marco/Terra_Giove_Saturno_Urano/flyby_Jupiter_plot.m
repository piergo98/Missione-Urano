...
flyby_jupiter1(r2_j,v_inf_down_Jupiter,f1_Jupiter,p_Jupiter,t_flyby_tot_Jupiter, m_Jupiter, r_Jupiter)
function [y]= flyby_jupiter1(r2_j, v_inf_down_Jupiter, f1_Jupiter, p_Jupiter, t_flyby_tot_Jupiter, m_Jupiter, r_Jupiter)
    ...
    %...Input data:
    %   Earth:
    m1 = m_Jupiter;    %massa di giove
    R  = r_Jupiter;  %raggio giove
