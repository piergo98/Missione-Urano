...
f1_Saturn_deg= rad2deg(f1_Saturn)
cosh_F_saturn=(e_flyby_Saturn+cos(f1_Saturn))/(e_flyby_Saturn*cos(f1_Saturn)+1)
...
t_flyby_tot_day_Saturn = t_flyby_tot_Saturn/(3600*24); % In ore
