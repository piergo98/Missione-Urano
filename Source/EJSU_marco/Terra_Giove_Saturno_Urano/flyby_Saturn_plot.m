...
flyby_jupiter1(v_inf_down_saturn, f1_Saturn, p_Saturn, t_flyby_tot_Saturn, m_Saturn, r_Saturn, V2_l_u,R_SOI_Saturn)
function [y]= flyby_jupiter1(v_inf_down_Saturn, f1_Saturn, p_Saturn, t_flyby_tot_Saturn, m_Saturn, r_Saturn,V2_l_u,R_SOI_Saturn)

hours = 3600;

%...Input data:
m1 = m_Saturn   % Massa Saturno in kg
R  = r_Saturn;  % Raggio Saturno
m2 = 10000;   %massa Spacecraft
G = 6.6742e-20; % Costante gravitazionale

t0 = 0;
tf = t_flyby_tot_Saturn;
%...End input data


%...Numerical integration:
mu = G*(m1 + m2);
r1 = [R_SOI_Saturn*cos(f1_Saturn), R_SOI_Saturn*sin(f1_Saturn), 0];
