...
plot_orbit2(2,	time_vector(1,1), planet_linewidth)		%Venus
...
for d = 1:fr_skip:n_days			% speed
	...
	% Venus (id = 3)
	[~, Venus_now, ~, ~]   = planet_elements_and_sv(2, year_now, month_now, day_now, 0, 0, 0);
	% Earth (id = 3)
    ...
    p_Venus		= plot3(Venus_now(1),Venus_now(2),Venus_now(3),'o','Color',col_venus, 'MarkerSize', dim_venus,'MarkerFaceColor',col_venus);				
