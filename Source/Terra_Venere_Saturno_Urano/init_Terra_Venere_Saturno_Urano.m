...
r_Venus = 6051.8;
d_Venus2Sun = 108200000;    %distance Earth-Sun in km
R_SOI_Venus = d_Venus2Sun*(m_Venus/m_Sun)^(2/5);   
...
%% Compute the ray of SOI_Jupiter
mu_Jupiter = 126686534; %[km^3/s^2] 
m_Jupiter = 1.898e27;    %Jupiter mass in kg
r_Jupiter = 6.9911e+4;
d_Jupiter2Sun = 778412020;    %distance Jupiter-Sun in km
R_SOI_Jupiter = d_Jupiter2Sun*(m_Jupiter/m_Sun)^(2/5); % ray SOI of jupiter
