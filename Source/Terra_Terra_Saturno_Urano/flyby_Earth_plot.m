...
flyby_Earth1(v_inf_down_Earth, f1_Earth, p_Earth, t_flyby_tot_Earth, m_Earth, r_Earth)
function [y]= flyby_Earth1(v_inf_down_Earth, f1_Earth, p_Earth, t_flyby_tot_Earth, m_Earth, r_Earth)

hours = 3600;

%...Input data:
m1 = m_Earth   % Massa Eartho in kg
R  = r_Earth;  % Raggio Eartho
m2 = 10000;   %massa Spacecraft
G = 6.6742e-20; % Costante gravitazionale

t0 = 0;
tf = t_flyby_tot_Earth;
%...End input data


%...Numerical integration:
mu = G*(m1 + m2);
r1 = [p_Earth*sin(f1_Earth), p_Earth*cos(f1_Earth), 0];
y0 = [r1 v_inf_down_Earth]';
